...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@hoteldemartin.COM</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">HOTEL <span>DEMARTIN</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
...
Lorem ipsum is simply dummy text of the printing and typesetting industry.Sed a betting pool sit throat. Now financing, biochemical and orange notebook, players receive no Reserved.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>You'll love all the discount we provide!. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/shamim.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/tuli.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Ratul.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/talbia.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/afrina.jpg" alt=" " class="img-responsive" />
					</li>
					</ul>
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>MD.Shamim Rahman</h4>
							<span>Owner</span>
							<p>Great Enviorment,Great Place,the labor and sorrow, some important things to do eiusmod.Over the years.</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Great Service.Give them 10 out of 10 </p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Best hotel for comfort.Their service is up to mark.</p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Best Service across the world. </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>One of the best.When I come to Bangladesh I always go to this hotel. </p>
								<h5>Amie Bublitz</h5>
								<p>Switzerland</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@DEMARTIN.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Kolatoli,Beach,CoxsBazar.
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d59412.29182350566!2d91.95998766817465!3d21.457989172988626!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x30adc7ea2ab928c3%3A0x3b539e0a68970810!2sCox&#39;s+Bazar!3m2!1d21.4272283!2d92.0058074!5e0!3m2!1sen!2sbd!4v1543687340101" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2018 DE MARTIN . All Rights Reserved | Design by <a href="index.php">Team Gladiators</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
